...
app.controller("migrateController",
    function ($q, $scope, $timeout, $log, $rootScope, drupal, cmsModel, fileDialog, userDefaults, migrate) {
        ...
        drupal.logout()   // logout of current CMS
            .then(function () {
                ...
                $scope.ready = true;  // user was not logged in - didn't need to logout
            });
                    ...
                    .then(function () {
                        ...
                        drupal.logout()
                            ...
                            .then(function () {
                                $timeout(function () {
                                    $scope.ui.running = false;
                                    $scope.ui.status = "Migration done!";
                                })
